...
./VOCdevkit/VOC2007/JPEGImages/000008.jpg 这里是四张测试的图片 用于获取候选框，具体如下：
1. 运行该py文件
2. 输入文件地址
3. 获取图片
'''
...
./img/1.jpg
./img/2.jpg
./img/3.jpg 三张非测试集 用于获取预测情况，具体如下：
1. 运行该py文件 将候选框代码注释，改为预测的代码
2. 输入文件地址
3. 获取图片
'''
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                ##候选框代码
                # r_image = frcnn.proposal_boxes(image, crop = crop, count = count)
                # r_image.show()
